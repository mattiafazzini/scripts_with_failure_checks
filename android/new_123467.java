...
public class new_123467{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target = mDevice.wait(Until.findObject(By.textContains("Kodan")),2000);
        target.click();
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("New cards/day")),2000);
        target.click();
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("270 cards due (2 h 30 m)")); 
