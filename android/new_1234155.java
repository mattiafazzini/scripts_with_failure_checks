...
public class new_1234155{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.res("com.fsck.k9:id/to")),2000);
        target.setText("abcdefghijklmnopqrstuvwxyz@outlook.com");
        target = mDevice.wait(Until.findObject(By.text("Subject")),2000);
        target.click();
        target.setText("test");
        target = mDevice.wait(Until.findObject(By.text("Message text")),2000);
        target.click();
        target.setText("test");
        target = mDevice.wait(Until.findObject(By.desc("Send")),2000);
        target.click();

        // Oracle
        UiObject2 element1 = mDevice.findObject(By.text("abcdefghijklmnopqrstuvwxyz@outlo, "));
