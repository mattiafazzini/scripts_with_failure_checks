...
public class new_123472 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.desc("Undo")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.desc("Undo")),2000);
        target.click();
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.res("com.ichi2.anki:id/new_number"));
        assertTrue(element1.getText().equals("-1"));
