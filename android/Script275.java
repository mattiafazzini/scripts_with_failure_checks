...
public class Script275 {
    ...
    public void performActions() throws UiObjectNotFoundException, InterruptedException {
        ...
        mDevice.findObject(new UiSelector().resourceId("com.beemdevelopment.aegis:id/next")).click();
        // add test password
        mDevice.findObject(new UiSelector().resourceId("com.beemdevelopment.aegis:id/text_password")).setText("test");
        //show password
        mDevice.findObject(new UiSelector().text("Show password")).click();
        // click "->"
        mDevice.findObject(new UiSelector().resourceId("com.beemdevelopment.aegis:id/next")).click();
        // oracle
        UiObject2 element1 = mDevice.findObject(By.text("Setup completed"));
