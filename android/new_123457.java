...
public class new_123457 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("Arabe_moderne")),2000);
        if(target != null) {
            target.click();
        }else {
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        mDevice.swipe(540,1800,540,0,20);
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("une crise")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Français")),2000);
        target.setText("une crise1");
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("une crise"));
