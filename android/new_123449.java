...
public class new_123449 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.fling(Direction.DOWN,20000);
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.text("日本語")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.text("カードブラウザ")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.text("testcard")),2000);
        ...
        target = mDevice.wait(Until.findObject(By.descContains("ョン")),2000);
        target.click();

        //oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("Card Info"));
