...
public class new_123498{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Good")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(2000);
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("anything")),2000);
        ...
        //oracle 
        UiObject2 element1 = mDevice.findObject(By.text("Reposition new card"));
