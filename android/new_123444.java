...
public class new_123444 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Front")),2000);
        target.setText("test2");
        target = mDevice.wait(Until.findObject(By.desc("Back")),2000);
        target.setText("test2a");
        target = mDevice.wait(Until.findObject(By.desc("Save")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Front")),2000);
        target.setText("test3");
        target = mDevice.wait(Until.findObject(By.desc("Back")),2000);
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("test1")),2000);
        ...
        target = mDevice.wait(Until.findObject(By.text("test2")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("More options")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Preview")),100);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Edit note")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("test")),100);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Default")),100);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Save")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("test2"));
