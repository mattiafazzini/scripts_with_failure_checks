...
public class Script205 {
    ...
    public void testChangeText_sameActivity() {
        ...
        UiObject2 search = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "homeViewTipsLabel")),2000);
        search.click();
        try {
...
//        UiObject2 focus = mDevice.wait(Until.findObject(By.text("Firefox Focus")),2000);
//        focus.click();
        UiObject2 open = mDevice.wait(Until.findObject(By.text("ERASE AND OPEN")),2000);
        open.click();

        //oracle 
        UiObject2 element1 = mDevice.findObject(By.text("https://www.google.com"));
