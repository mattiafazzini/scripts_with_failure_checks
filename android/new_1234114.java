...
public class new_1234114{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target = mDevice.wait(Until.findObject(By.textContains("ptions")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("New cards")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Add")),2000);
        if(target!=null) {
            target.click();
        }
        target = mDevice.wait(Until.findObject(By.textContains("Steps (in minutes)")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.clazz("android.widget.EditText")),2000);
        target.setText("0.06589999794960022 1.5 10 1440");
        target = mDevice.wait(Until.findObject(By.text("OK")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.pressBack();
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("AGAIN")),2000);
        target.click();
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("Collection not opened")); 
