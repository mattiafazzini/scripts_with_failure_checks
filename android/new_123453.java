...
public class new_123453 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("testq1")),2000);
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Reposition")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Start position:")),2000);
        target.setText("2");
        target = mDevice.wait(Until.findObject(By.text("OK")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        ...
        //oracle
        List<UiObject2> element1 = mDevice.findObjects(By.textContains("testq")); 
        assertTrue(!element1.get(1).getText().equals("testq1"));
