...
public class new_1234152{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("IMAP")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("imap.outlook.com")),2000);
        ...
        mDevice.pressBack();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.textContains("POP")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(5000);
        
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("993"));
