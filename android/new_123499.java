...
public class new_123499{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.setText("testcard that should disappear");
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Scheduling")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Reschedule")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.clazz("android.widget.EditText")),2000);
        target.setText("9");
        target = mDevice.wait(Until.findObject(By.text("OK")),2000);
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("testcard that should disappear"));  
