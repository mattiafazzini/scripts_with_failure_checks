...
public class new_1234143 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("App Manager")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.res("com.amaze.filemanager:id/properties")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("Uninstall")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(6000);
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("uninstall"));
        assertTrue(element1.getText() == null);
