...
public class new_123451{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.setText("Custom study session");
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Review ahead")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("OK")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        ...
        //oracle 
        UiObject2 element1 = mDevice.findObject(By.text("Custom study"));
