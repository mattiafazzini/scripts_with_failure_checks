...
public class Script1428 {
    ...
    public void performGUIActions() throws UiObjectNotFoundException, IOException {
        ...
        // oracle
        UiObject2 container = uiDevice.findObject(By.res("com.easyfitness:id/singlevalueinput_unitSpinner"));
        UiObject2 element1 = container.findObject(By.res("android:id/text1"));
        assertTrue(element1.getText().equals("kg"));
        // oracle alternative
        //UiObject2 element1 = uiDevice.findObject(By.text("kg"));
