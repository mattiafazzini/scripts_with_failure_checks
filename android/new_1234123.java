...
public class new_1234123 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Color")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Select color config")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);

        // Oracle 
        UiObject2 element1 = mDevice.findObject(By.textContains("Customize"));
