...
public class new_123454 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.setText("*Hello (zanki)");
        target = mDevice.wait(Until.findObject(By.text("OK")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("*Hello (zanki)")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Add")),2000);
        target.click();
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("0 cards shown"));
