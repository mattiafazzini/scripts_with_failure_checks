...
public class new_123490 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Limit to")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.clazz("android.widget.EditText")),2000);
        target.setText("1");
        target = mDevice.wait(Until.findObject(By.text("OK")),2000);
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.textContains("Good")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.text("SHOW ANSWER")),2000);
        target.click();
        ...
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.text("Filtered Deck 2")),2000);
        ...
        target = mDevice.wait(Until.findObject(By.text("Options")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Search")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.clazz("android.widget.EditText")),2000);
        ...
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.findObject(By.text("Filtered Deck 2"));
        target.click();


        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("Congratulations! You have finished for now.")); 
