...
public class new_123446 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Safe display mode")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.click(32,300);
        TimeUnit.MILLISECONDS.sleep(1000);

        //oracle 
        UiObject2 element1 = mDevice.findObject(By.text("Settings"));
