...
public class new_123459 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Change display order")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("created time")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("More options")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Change display order")),2000);
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("test3"));
