...
public class new_1234249{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Stream")),20000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("More options")),20000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Open Podcast")),20000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("More options")),20000);
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("Remove")),20000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Confirm")),2000);
        target.click();
        ...
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("Besties"));
