...
public class new_123456{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        UiObject2 back = mDevice.findObject(By.text("back"));
        while(back == null) {
            target = mDevice.wait(Until.findObject(By.desc("Back")), 2000);
            target.setText("back");
            TimeUnit.MILLISECONDS.sleep(2000);
            back = mDevice.findObject(By.text("back"));
        }
        TimeUnit.MILLISECONDS.sleep(2000);
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("back")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Attach multimedia content to the Front field")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("CAMERA")),2000);
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.clazz("android.widget.Image"));
        assertTrue(element1.getVisibleBounds().bottom-element1.getVisibleBounds().top < 50);
    }
