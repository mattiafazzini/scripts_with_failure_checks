...
public class new_1234171{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException, IOException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("General settings")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Display")),2000);
        target.click();
        ...
        target = mDevice.wait(Until.findObject(By.text("فارسی")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.pressBack();
        TimeUnit.MILLISECONDS.sleep(1000);
        ...
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("Load up to 25 more"));
