...
public class new_1234266{
    ...
    public void testChangeText_sameActivity() throws InterruptedException {
        ...
        mDevice = UiDevice.getInstance(getInstrumentation());
        UiObject2 target = mDevice.wait(Until.findObject(By.text("Settings")),2000);
        target.click();
        ...
        mDevice.pressSearch();
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("High Notification priority"));
