...
public class Script91 {

    private static final String BASIC_SAMPLE_PACKAGE
            = "com.vrem.wifianalyzer.BETA";
    ...
    public void testChangeText_sameActivity() throws IOException, UiObjectNotFoundException {
        ...
        mDevice.findObject(new UiSelector().resourceId("com.vrem.wifianalyzer.BETA:id/action_filter").index(0)).click();
        mDevice.findObject(new UiSelector().text("ssid SSID")).click();
