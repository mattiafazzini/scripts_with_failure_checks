...
public class new_1234269{
    ...
    public void testChangeText_sameActivity() throws InterruptedException {
        ...
        target = mDevice.wait(Until.findObject(By.text("Play")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.res("de.danoeh.antennapod:id/txtvAuthor")),2000);
        target.click();
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.res("de.danoeh.antennapod:id/txtvEpisodeTitle"));
