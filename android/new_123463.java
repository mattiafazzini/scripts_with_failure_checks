...
public class new_123463 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Preview")),2000);
        target.click();
        mDevice.swipe(540,1500,540,500,10);
        mDevice.swipe(540,65,540,500,10);

        //oracle
        List<UiObject2> element1 = mDevice.findObjects(By.text("SHOW ANSWER")); 
        assertTrue(element1.size() == 2);
