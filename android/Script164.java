...
public class Script164 {
    ...
    public void testChangeText_sameActivity() {
        ...
        UiObject2 Manual = mDevice.wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "manual_setup")),2000);
        Manual.click();
        //With some devices, two pressBack()call is required
        mDevice.pressBack();
        mDevice.pressBack();

        //oracle
        //UiObject2 element1 = mDevice.findObject(By.text("Contacts"));
//        UiObject2 element2 = mDevice.findObject(By.text("IMAP"));
//        assertTrue(element1 != null && element2 == null);
        UiObject2 element1 = mDevice.findObject(By.text("Set up a new account"));
        assertTrue(element1 == null);
        //alternative
//        UiObject2 element2 = mDevice.findObject(By.desc("Apps"));
