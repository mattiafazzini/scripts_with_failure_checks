...
public class new_1234260{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(4000);
        target = mDevice.wait(Until.findObject(By.res("de.danoeh.antennapod.debug:id/txtvTitle").minDepth(1)),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        ...
        target = mDevice.wait(Until.findObject(By.desc("AntennaPod Debug")),2000);
        target.click();
        ...
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.descContains("menu"));
