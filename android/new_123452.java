...
public class new_123452 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Front")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Rename field")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);


        //oracle 
        UiObject2 element1 = mDevice.findObject(By.text("Rename note type"));
