...
public class Script155 {
    ...
    public void performActions() throws UiObjectNotFoundException, InterruptedException {
        // click "->"
        mDevice.findObject(new UiSelector().resourceIdMatches(".*[n|N]ext.*")).click();
        // click "none"
        mDevice.findObject(new UiSelector().text("None")).click();
        // click "->"
        mDevice.findObject(new UiSelector().resourceIdMatches(".*[n|N]ext.*")).click();
        // click "tick"
        ...
        UiObject2 target = mDevice.wait(Until.findObject(By.text("Appearance")),2000);
        if(target != null){
            target.click();
        }
        // click language
        ...
        //oracle
        UiObject2 element1 = mDevice.findObject(By.text("Czech"));
