...
public class new_1234164{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target = mDevice.wait(Until.findObject(By.textContains("MANUAL")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("POP3")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("pop3.outlook.com")),2000);
        target.setText("outlook.office365.com");
        ...
        target = mDevice.wait(Until.findObject(By.text("CONTINUE")),5000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("NEXT")),2000);
        target.click();
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.text("delete me")),2000);
        mDevice.swipe(target.getVisibleCenter().x,target.getVisibleCenter().y,target.getVisibleCenter().x,target.getVisibleCenter().y,100);
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.desc("Delete")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.desc("Open")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("All messages in unified folders")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        ...
        target = mDevice.wait(Until.findObject(By.desc("Open")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Trash")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("delete me"));
