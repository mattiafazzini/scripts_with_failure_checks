...
public class new_1234173{
    ...
    // you must enable developer mode and set the max background apps to none
    @Test
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException, IOException {
        ...
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.text("Junk")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        target = mDevice.wait(Until.findObject(By.textContains("Load")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.textContains("Welcome!")),2000);
        if(target!=null) {
            ...
            mDevice.pressHome();
            TimeUnit.MILLISECONDS.sleep(1000);
            mDevice.swipe(540, 1700, 540, 1000, 20);
        ...
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("1 selected"));
