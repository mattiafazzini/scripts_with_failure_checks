...
public class new_123488 {
    ...
    public void testChangeText_sameActivity() throws InterruptedException, IOException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.res("com.ichi2.anki:id/CardEditorCardsButton")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.res("com.ichi2.anki:id/front_edit")),2000);
        target.setText("{{Front}}\n<button><a href=\"www.google.com\"></button>");
        ...
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.text("Reviewing")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Fullscreen mode")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Hide the system bars and answer buttons")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        mDevice.click(100,100);
        TimeUnit.MILLISECONDS.sleep(2000);
        ...
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.clazz("android.widget.Button")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(2000);
