...
public class new_1234178{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("long")),2000);
        if(target==null){
            target = mDevice.wait(Until.findObject(By.textContains("Load")),2000);
            target.click();
            target = mDevice.wait(Until.findObject(By.text("long")),2000);
        }
        target.click();
        TimeUnit.MILLISECONDS.sleep(5000);
        target = mDevice.wait(Until.findObject(By.text("DOWNLOAD COMPLETE MESSAGE")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(5000);
        // Oracle
