...
public class new_1234183{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        target = mDevice.wait(Until.findObject(By.text("Fetching mail")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Sync messages from")),2000);
        target.click();
        target = mDevice.wait(Until.findObject(By.text("today")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.pressBack();
        TimeUnit.MILLISECONDS.sleep(1000);
        ...
        target.click();
        target = mDevice.wait(Until.findObject(By.text("Enable server search")),2000);
        target.click();
        mDevice.pressBack();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.pressBack();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.swipe(540,200,540,1500,20);
        TimeUnit.MILLISECONDS.sleep(5000);
        target = mDevice.wait(Until.findObject(By.res("com.fsck.k9:id/search")),2000);
        if(target==null) {
            TimeUnit.MILLISECONDS.sleep(1000);
            mDevice.click(100,100);
            TimeUnit.MILLISECONDS.sleep(1000);
        ...
        mDevice.swipe(540,500,540,1500,200);
        TimeUnit.MILLISECONDS.sleep(5000);
        target = mDevice.wait(Until.findObject(By.text("testqwertyuiop")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(5000);
        // Oracle
        UiObject2 element1 = mDevice.findObject(By.textContains("BODYTEXTSHOULDBEDISPLAYEDHERE"));
