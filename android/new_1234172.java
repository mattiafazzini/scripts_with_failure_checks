...
public class new_1234172{
    ...
    public void testChangeText_sameActivity() throws InterruptedException, RemoteException {
        ...
        mDevice.pressHome();
        TimeUnit.MILLISECONDS.sleep(1000);
//        target = mDevice.wait(Until.findObject(By.text("App info")),2000);
//        target.click();
        TimeUnit.MILLISECONDS.sleep(1000);
        mDevice.pressRecentApps();
        TimeUnit.MILLISECONDS.sleep(2000);
        target = mDevice.wait(Until.findObject(By.desc("K-9 Mail")),2000);
        target.click();
        TimeUnit.MILLISECONDS.sleep(5000);

        // Oracle
        UiObject2 element1 = mDevice.findObject(By.text("long"));
